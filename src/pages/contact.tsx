...
function contact() {
 ...
 <section>
    ...
    <p className='text-center text-2xl py-5'><a href='mailto:suganros52@gmail.com' className='p-2 rounded-md border-double border-2 border-blue-300 hover:text-blue-300'>Say hello</a></p>
